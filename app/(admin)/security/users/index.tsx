import { ServerList, type Column, type ServerListHandle } from '@/components/generic/ServerList';
import { ThemedText } from '@/components/themed-text';
import UserRowActions from '@/components/users/UserRowActions';
import { useUserPasswordFlow } from '@/components/users/useUserPasswordFlow';
...
export default function UserScreen() {
  ...
  const columns: Column<User>[] = [
    ...
    {
      key: 'role', header: 'Nombre del Role', sortable: true, align: 'left',
      render: (r) => (
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
      ...
      <ServerList<User>
        ...
        renderRowActions={(row) => (
          <UserRowActions
            ...
            onEdit={() => router.push(`/(admin)/security/users/${row.id}` as const)}
